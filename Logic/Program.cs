...
namespace Logic
{
    class Program
    {
        static void Main() // We will need to delete.
        {
            ...
            Engine.makeKing(abc.gameBoard,0 ,1);
            Engine.makeKing(abc.gameBoard, 1,0 );
            Engine.makeKing(abc.gameBoard, 7, 6);
            Engine.makeKing(abc.gameBoard, 5, 0);
            abc.PrintBoard(abc.gameBoard, res);
